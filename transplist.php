		...
		<div class="rows n-dis-pack inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space pad-bot-redu-5" id="inner-page-title">
				...
				<div class="spe-title col-md-12">
					<h2>Empresas de <span>Transporte</span></h2>
				...
				<div class="rows">
                    <?php 
                        ...
                        while ($row = $conexion->getRow($resultado)) {
                            echo '<!--====== DISCOUNT ==========-->
                                    <div class="col-md-4 col-sm-4">
                                        <div class="pack_price">
                                            ...
                                            <ul>
                                                ...
                                                <li>Hora apertura: '.$row["horaApertura"].'</li>
                                                <li>Hora cierre: '.$row["horaCierre"].'</li>
                                                <li><a href="pag-transp.php?idEmpresa='.$row["idEmpresaTransporte"].'" class="link-btn">Ver Más</a> </li>
                                            </ul>
                                        </div>
                                    </div>';
                          } 
